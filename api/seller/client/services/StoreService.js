...
class StoreService {
     ...
     * @throws ApiError
     */
    getAllStores({ pageSize = 20, status, orderBy, order, periodFrom = '2023-01-01T00:00:00.000Z', periodTo = '2023-07-20T16:56:27.846Z', nextPageIndex, name, userId, revenueFrom, revenueTo, }) {
        return this.httpRequest.request({
            method: 'GET',
            url: '/store',
            query: {
