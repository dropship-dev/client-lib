...
import { PodProductTypeService } from './services/PodProductTypeService';
...
export class ClientApi {
  ...
  public readonly podElement: PodElementService;
  public readonly podProductType: PodProductTypeService;
  ...
  constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = AxiosHttpRequest) {
    ...
    this.podElement = new PodElementService(this.request);
    this.podProductType = new PodProductTypeService(this.request);
