...
const PodProductTypeService_1 = require("./services/PodProductTypeService");
...
class ClientApi {
    ...
    constructor(config, HttpRequest = AxiosHttpRequest_1.AxiosHttpRequest) {
        ...
        this.podProductType = new PodProductTypeService_1.PodProductTypeService(this.request);
